...
<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
	<div class="container-fluid">
		<table class="table table-hover my-4" style="width:70%; margin: auto; ">
			...
			<tr>
				<td>제목</td>
				<td><input type="text" name="md_title" id="md_title" value="${mdedit.md_title}" class="form-control"></td>
			</tr>
			<tr>
				<td>파일 업로드</td>
				<td><input type="file" name="file1" id="file1" value="${mdedit.md_upload}" class="form-control"></td>
			</tr>
			<tr>
				<td>노출일정</td>
				<td>
			...
			<tr>
				<td>내용</td>
				<td>
					<textarea name="md_memo" id="md_memo" rows="3" cols="50"  class="form-control">
					${mdedit.md_memo}</textarea>
				</td>
			</tr>
		</table>
	</div>
	<div class="text-center" style="margin-bottom: 20;">
   	...
   	<div style="width:70%; margin:auto;" class="text-end">
        <a href="/admin/mdPickList">MD 리스트</a>로 이동
    </div>
